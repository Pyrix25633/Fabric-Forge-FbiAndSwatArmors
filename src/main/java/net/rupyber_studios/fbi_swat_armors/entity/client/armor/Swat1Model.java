...
public class Swat1Model extends GeoModel<Swat1Item> {
    private static final Identifier MODEL_RESOURCE = Identifier.of(FbiSwatArmors.MOD_ID, "geo/armor1.geo.json");
    private static final Identifier TEXTURE_RESOURCE = Identifier.of(FbiSwatArmors.MOD_ID, "textures/models/armor/swat1.png");
    private static final Identifier ANIMATION_RESOURCE = Identifier.of(FbiSwatArmors.MOD_ID, "animations/swat1.animations.json");
